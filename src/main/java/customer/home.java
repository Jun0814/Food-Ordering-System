...
public class home extends javax.swing.JFrame {
    ...
    public home(List<Customer> userInfo) {
        ...
        initComponents();
        setImage();
        for (Customer customer : userInfo) {
    ...
    public void setImage(){
        ...
        ImageIcon logo = scale.processImage("src\\main\\java\\repository\\logo.png",160,80);
     ...
     */
    public void run() {
        new home(userInfo).setVisible(true);
    }
